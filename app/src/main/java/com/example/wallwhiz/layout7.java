...
import com.example.wallwhiz.databinding.ActivityLayout7Binding;
...
public class layout7 extends AppCompatActivity {
    ...
    private ActivityLayout7Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLayout7Binding.inflate(getLayoutInflater());
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(layout7.this, acrylicframe.class));
            }
        });
